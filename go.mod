...
require (
	...
	github.com/americanas-go/config v1.8.3
	...
	github.com/americanas-go/log v1.8.7
...
require (
	...
	golang.org/x/crypto v0.8.0 // indirect; indirect221014153046-6fdb5e3db783 // indirect
