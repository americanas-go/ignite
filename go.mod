...
require (
	...
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.54.0-devel // indirect
	...
	golang.org/x/crypto v0.22.0 // indirect; indirect221014153046-6fdb5e3db783 // indirect
